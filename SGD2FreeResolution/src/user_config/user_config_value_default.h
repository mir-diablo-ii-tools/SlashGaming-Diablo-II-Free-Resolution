...
#ifndef SGD2FR_USER_CONFIG_USER_CONFIG_VALUE_DEFAULT_H_
#define SGD2FR_USER_CONFIG_USER_CONFIG_VALUE_DEFAULT_H_
...
#endif /* SGD2FR_USER_CONFIG_USER_CONFIG_VALUE_DEFAULT_H_ */
