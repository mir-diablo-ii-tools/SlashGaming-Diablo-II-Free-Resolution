...
void ConfigIni_WriteDefault(const wchar_t* path) {
  ...
  is_write_success = WritePrivateProfileStringW(
      ...
      TO_WIDE(TO_STR(CONFIG_INGAME_RESOLUTION_MODE_DEFAULT)),
      path
  );

  is_write_success = WritePrivateProfileStringW(
      CONFIG_INGAME_RESOLUTIONS_SECTION,
      L"Resolution 0.Width",
      L"640",
      path
  );
  ...
  is_write_success = WritePrivateProfileStringW(
      ...
      TO_WIDE(TO_STR(CONFIG_IS_ENABLE_SCREEN_BORDER_FRAME_DEFAULT)),
      path
  );
  ...
  is_write_success = WritePrivateProfileStringW(
      ...
      TO_WIDE(TO_STR(CONFIG_IS_USE_800_INTERFACE_BAR_DEFAULT)),
      path
  );
  ...
  is_write_success = WritePrivateProfileStringW(
      ...
      TO_WIDE(TO_STR(CONFIG_IS_USE_ORIGINAL_SCREEN_BORDER_FRAME_DEFAULT)),
      path
  );
  ...
  is_write_success = WritePrivateProfileStringW(
      CONFIG_MAIN_SECTION,
      TO_WIDE(CONFIG_MAIN_MENU_RESOLUTION) L".Width",
      TO_WIDE(TO_STR(CONFIG_MAIN_MENU_RESOLUTION_WIDTH_DEFAULT)),
      path
  );
  ...
  is_write_success = WritePrivateProfileStringW(
      CONFIG_MAIN_SECTION,
      TO_WIDE(CONFIG_MAIN_MENU_RESOLUTION) L".Height",
      TO_WIDE(TO_STR(CONFIG_MAIN_MENU_RESOLUTION_HEIGHT_DEFAULT)),
      path
  );
}
