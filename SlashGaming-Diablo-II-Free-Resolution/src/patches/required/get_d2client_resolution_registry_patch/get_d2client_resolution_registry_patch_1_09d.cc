...
#include "get_d2client_resolution_registry_patch_1_09d.hpp"

#include "../../../asm_x86_macro.h"
#include "get_d2client_resolution_registry.hpp"
...
__declspec(naked) void __cdecl InterceptionFunc_01() {
  ...
  ASM_X86(push ecx);
  ASM_X86(push esi);
  ASM_X86(call ASM_X86_FUNC(SGD2FR_GetD2ClientResolutionRegistry));
  ASM_X86(add esp, 8);
