...
const std::vector<std::tuple<int, int>>& GetResolutionsFromIpV4(
  ...
  static const Ipv4HashResolutionTableEntry kSortedIpv4ResolutionTable[] = {
      ...
      // cham's server (D2Infinite)
      Ipv4HashResolutionTableEntry(
          "24C90D068A9D7F21009B608931FA20DFE4D3A198",
          {
            kResolution640x480,
            kResolution800x600,
            std::make_tuple(856, 480),
      ...
      // 2nd Dubai Server
      Ipv4HashResolutionTableEntry(
          "52DE5E29192A579C5FC93EDB18C706670E67C87C",
          {
              kResolution640x480,
              kResolution800x600,
              std::make_tuple(1068, 600),
      ...
      // Mayhem's Anonymous PVP server
      Ipv4HashResolutionTableEntry(
        "58F90080593D201404766467C60FA670A8E79C5E",
        {
            kResolution640x480,
            kResolution800x600,
            std::make_tuple(1068, 600),
      ...
      // D2 DarkSide Beta
      Ipv4HashResolutionTableEntry(
          "5B6F28CAC42678962FCBC36A1FB30F6A6A0B5C16",
          {
              std::make_tuple(1068, 600),
              std::make_tuple(1280, 720)
          }),
      ...
      // SB Server
      Ipv4HashResolutionTableEntry(
          "76A47591C971AE6C6D3E2DD59C92C18801FE9D67",
          {
              std::make_tuple(1068, 600),
              std::make_tuple(1344, 700)
          }),
      ...
      // D2 DarkSide
      Ipv4HashResolutionTableEntry(
          "7D3B481E1DBE4637A95A47A9AEEC691154BADB51",
          {
              std::make_tuple(1068, 600),
              std::make_tuple(1280, 720)
          }),
      ...
      // Malcolm's Server
      Ipv4HashResolutionTableEntry(
          "BD7A3A40D689B0AC49DC80326EE6BEF9519786A2",
          {
              kResolution800x600,
              std::make_tuple(1068, 600),
              std::make_tuple(1280, 720),
      ...
      // 4th Dubai server
      Ipv4HashResolutionTableEntry(
          "E9D03E6261BAFF701363F76A94DBBE49FEB56D9F",
          {
              kResolution640x480,
              kResolution800x600,
              std::make_tuple(1068, 600),
