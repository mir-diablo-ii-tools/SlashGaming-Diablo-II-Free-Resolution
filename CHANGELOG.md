...
## SGD2FreeRes 3.0.4.0.0047 (August 17, 2025)
- Add fernandosys's D2PRIME servers with 800x600, 1024x640, and
  1280x720.
...
## SGD2FreeRes 3.0.4.0.0039 (January 7, 2025)
- Update Ale's D2Revenge server IP.

## SGD2FreeRes 3.0.4.0.0038 (January 7, 2025)
- Update NOWD/NWD server IP.
...
## SGD2FreeRes 3.0.4.0.0035 (January 1, 2025)
- Add Mb's SB Server with 1068x600 and 1344x700.
...
## SGD2FreeRes 3.0.4.0.0031 (September 22, 2024)
- Update IP of D2Revenge.

## SGD2FreeRes 3.0.4.0.0030 (September 10, 2024)
- Add MykoticTTV's Kotic server with 800x600, 1068x600, and 1280x720.

## SGD2FreeRes 3.0.4.0.0029 (August 9, 2024)
- Add Inhuman's Auratum server with 1280x720.
...
## SGD2FreeRes 3.0.4.0x (April 14, 2024)
- Add Tetsuya's server with 640x480, 800x600, 856x480, and 1068x600.

## SGD2FreeRes 3.0.4.0w4 (March 26, 2024)
- Reenable Ale's server.

## SGD2FreeRes 3.0.4.0w3 (March 19, 2024)
- Add 800x600 to HiddenGamers Diablo server.
